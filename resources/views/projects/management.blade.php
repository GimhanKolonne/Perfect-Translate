...
@section('content')
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 bg-gray-50">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <button onclick="toggleProjectDetails({{ $project->id }})" class="text-blue-600 hover:text-blue-900">Toggle Details</button>
                                <a href="{{ route('projects.view-projects', $project->id) }}" class="text-blue-600 hover:text-blue-900">View Details</a>
                                <a href="{{ route('chat.index', $project->id) }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition duration-150 ease-in-out">
                                    Chat
                                </a>
                            </div>
                        </td>
        ...
        @if ($projects->isEmpty())
            <div class="mt-8 text-center text-gray-500">No accepted projects found.</div>
        @endif

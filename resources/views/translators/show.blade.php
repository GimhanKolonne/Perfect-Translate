                    ...
                    <div class="px-4 py-5 sm:px-6 sm:py-6">
                        <div class="sm:flex sm:items-center sm:justify-between">
                            ...
                            <div class="mt-5 flex justify-center sm:mt-0">
                                <a href="{{ route('translators.edit', $translator) }}" class="flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                                    {{ __('Edit Profile') }}
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-white shadow-lg rounded-lg p-6 border border-gray-200">
                            ...
                            <div class="flex flex-wrap">
                                @foreach(json_decode($translator->language_pairs) as $pair)
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800 mr-2 mb-2">
                                        {{ $pair }}
                                    </span>
                                @endforeach
                            </div>
                        ...
                        <div class="bg-white shadow-lg rounded-lg p-6 border border-gray-200">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <a href="{{ route('portfolios.create') }}" class="text-purple-600 hover:text-purple-800">{{ __('Add New Portfolio') }}</a>
                            </div>
                                ...
                                @foreach($translator->portfolios as $portfolio)
                                    <li class="py-3 flex items-center justify-between">
                                        ...
                                        <div class="ml-4 flex-shrink-0">
                                            <a href="{{ route('portfolios.edit', $portfolio) }}" class="text-blue-500 hover:text-blue-700">{{ __('Edit') }}</a>
                                        </div>
                                    </li>
                                @endforeach
                            </ul>
